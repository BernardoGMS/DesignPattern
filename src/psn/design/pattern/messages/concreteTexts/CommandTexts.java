...
public class CommandTexts implements TextsInterface {
    ...
    public void displayEnglishTexts() {
        ...
        this.textsConstructor.setCurrentText(MessagesEN.CASESTUDY_COMMAND_TEXT_P1);
        this.textsConstructor.setCurrentTitle(MessagesEN.CASESTUDY_COMMAND.toUpperCase());
        ...
        this.textsConstructor.setCurrentText(MessagesEN.CASESTUDY_COMMAND_TEXT_P2);
        this.textsConstructor.constructText();
        this.textsConstructor.setCurrentText(MessagesEN.CASESTUDY_COMMAND_TEXT_P3);
        this.textsConstructor.constructText();
        this.textsConstructor.constructTextDown(1);

        this.textsConstructor.setCurrentSubTitle(MessagesEN.CASESTUDY_PROBLEM);
        this.textsConstructor.constructTextSubTitle();
        this.textsConstructor.setCurrentText(MessagesEN.CASESTUDY_COMMAND_TEXT_P4);
        this.textsConstructor.constructText();
        this.textsConstructor.constructTextDown(1);
    ...
    public void displayPortugueseTexts() {
        ...
        this.textsConstructor.setCurrentText(MessagesPT.CASESTUDY_COMMAND_TEXT_P1);
        this.textsConstructor.setCurrentTitle(MessagesPT.CASESTUDY_COMMAND.toUpperCase());
        this.textsConstructor.constructTextTitle();
        this.textsConstructor.setCurrentSubTitle(MessagesPT.CASESTUDY_INTENT);
        this.textsConstructor.constructTextSubTitle();

        this.textsConstructor.constructText();
        this.textsConstructor.setCurrentText(MessagesPT.CASESTUDY_COMMAND_TEXT_P2);
        this.textsConstructor.constructText();
        this.textsConstructor.setCurrentText(MessagesPT.CASESTUDY_COMMAND_TEXT_P3);
        this.textsConstructor.constructText();
        this.textsConstructor.constructTextDown(1);

        this.textsConstructor.setCurrentSubTitle(MessagesPT.CASESTUDY_PROBLEM);
        this.textsConstructor.constructTextSubTitle();
        this.textsConstructor.setCurrentText(MessagesPT.CASESTUDY_COMMAND_TEXT_P4);
        this.textsConstructor.constructText();
        this.textsConstructor.constructTextDown(1);
