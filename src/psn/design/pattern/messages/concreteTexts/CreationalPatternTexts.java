...
public class CreationalPatternTexts implements TextsInterface {
    ...
    public void displayEnglishTexts() {
        ...
        this.textsConstructor.setCurrentText(MessagesEN.TEXT_CREATIONALPATTERN_CONCEPT_P1);
        this.textsConstructor.setCurrentTitle(MessagesEN.TEXT_CREATIONALPATTERN_CONCEPT_TITLE);
    ...
    public void displayPortugueseTexts() {
        ...
        this.textsConstructor.setCurrentText(MessagesPT.TEXT_CREATIONALPATTERN_CONCEPT_P1);
        this.textsConstructor.setCurrentTitle(MessagesPT.TEXT_CREATIONALPATTERN_CONCEPT_TITLE);
        this.textsConstructor.constructTextTitle();
        this.textsConstructor.constructText();
        this.textsConstructor.constructTextDown(3);
    }
